...
const MENU_DATA = [
  ...
  { id: 4, category: 'Main', name: { ko: '갈릭 버터 랍스터 파스타', en: 'Garlic Butter Lobster Pasta', ja: 'ガーリックロブスターパスタ', zh: '蒜香黄油龙虾意面' }, price: 32000, img: '🦞' },
  { id: 5, category: 'Main', name: { ko: '허브 로스트 치킨 플래터', en: 'Herb Roasted Chicken Platter', ja: 'ハーブローストチキン', zh: '香草烤鸡拼盘' }, price: 28000, img: '🍗' },
  { id: 6, category: 'Main', name: { ko: '블랙페퍼 안심 스테이크', en: 'Black Pepper Tenderloin Steak', ja: 'ブラックペッパーヒレステーキ', zh: '黑胡椒菲力牛排' }, price: 46000, img: '🥩' },
  { id: 7, category: 'Main', name: { ko: '쉬림프 로제 리조또', en: 'Shrimp Rose Risotto', ja: 'シュリンプロゼリゾット', zh: '虾仁玫瑰酱烩饭' }, price: 25000, img: '🍤' },
  { id: 8, category: 'Main', name: { ko: '멕시칸 비프 타코 플레이트', en: 'Mexican Beef Taco Plate', ja: 'ビーフタコプレート', zh: '墨西哥牛肉塔可拼盘' }, price: 24000, img: '🌮' },
  { id: 9, category: 'Main', name: { ko: '연어 스테이크 & 레몬버터', en: 'Salmon Steak & Lemon Butter', ja: 'サーモンステーキ', zh: '柠檬黄油三文鱼排' }, price: 31000, img: '🐟' },
  { id: 10, category: 'Main', name: { ko: '클래식 라자냐', en: 'Classic Lasagna', ja: 'クラシックラザニア', zh: '经典千层面' }, price: 23000, img: '🍝' },
  { id: 11, category: 'Main', name: { ko: '매콤 해산물 토마토 스튜', en: 'Spicy Seafood Tomato Stew', ja: 'スパイシーシーフードシチュー', zh: '辣味海鲜番茄炖锅' }, price: 29000, img: '🍲' },
  { id: 12, category: 'Main', name: { ko: '더블 치즈 수제버거', en: 'Double Cheese Handmade Burger', ja: 'ダブルチーズバーガー', zh: '双层芝士手工汉堡' }, price: 21000, img: '🍔' },
  { id: 13, category: 'Main', name: { ko: '바질 페스토 뇨끼', en: 'Basil Pesto Gnocchi', ja: 'バジルペストニョッキ', zh: '罗勒青酱意式团子' }, price: 22000, img: '🥬' },
  ...
  { id: 103, category: 'Side', name: { ko: '갈릭 브레드 바스켓', en: 'Garlic Bread Basket', ja: 'ガーリックブレッド', zh: '蒜香面包篮' }, price: 7000, img: '🥖' },
  { id: 104, category: 'Side', name: { ko: '시저 샐러드', en: 'Caesar Salad', ja: 'シーザーサラダ', zh: '凯撒沙拉' }, price: 11000, img: '🥬' },
  { id: 105, category: 'Side', name: { ko: '치즈 오븐 나초', en: 'Cheese Oven Nachos', ja: 'チーズナチョス', zh: '芝士焗玉米片' }, price: 12000, img: '🧀' },
  { id: 106, category: 'Side', name: { ko: '버팔로 윙 6pcs', en: 'Buffalo Wings 6pcs', ja: 'バッファローウィング', zh: '水牛城辣鸡翅' }, price: 14000, img: '🍗' },
  { id: 107, category: 'Side', name: { ko: '모짜렐라 스틱', en: 'Mozzarella Sticks', ja: 'モッツァレラスティック', zh: '马苏里拉芝士条' }, price: 10000, img: '🧀' },
  { id: 108, category: 'Side', name: { ko: '그릴드 야채 플래터', en: 'Grilled Vegetable Platter', ja: 'グリル野菜', zh: '烤时蔬拼盘' }, price: 13000, img: '🥦' },
  { id: 109, category: 'Side', name: { ko: '머쉬룸 크림수프', en: 'Mushroom Cream Soup', ja: 'マッシュルームスープ', zh: '奶油蘑菇汤' }, price: 9000, img: '🍄' },
  { id: 110, category: 'Side', name: { ko: '스파이시 어니언 링', en: 'Spicy Onion Rings', ja: 'スパイシーオニオンリング', zh: '香辣洋葱圈' }, price: 8000, img: '🧅' },
  { id: 111, category: 'Side', name: { ko: '허니 버터 콘립', en: 'Honey Butter Corn Ribs', ja: 'ハニーバターコーンリブ', zh: '蜂蜜黄油玉米肋排' }, price: 9500, img: '🌽' },
  { id: 112, category: 'Side', name: { ko: '수제 피클 플레이트', en: 'Homemade Pickle Plate', ja: '自家製ピクルス', zh: '手工腌菜拼盘' }, price: 6000, img: '🥒' },
  ...
  { id: 206, category: 'Drink', name: { ko: '샤르도네 (White)', en: 'Chardonnay', ja: '白ワイン', zh: '霞多丽白葡萄酒' }, price: 14000, img: '🥂' },
  { id: 207, category: 'Drink', name: { ko: '스파클링 와인', en: 'Sparkling Wine', ja: 'スパークリングワイン', zh: '起泡酒' }, price: 17000, img: '🍾' },
  { id: 208, category: 'Drink', name: { ko: '하이볼', en: 'Highball', ja: 'ハイボール', zh: '威士忌苏打' }, price: 11000, img: '🥃' },
  { id: 209, category: 'Drink', name: { ko: '진토닉', en: 'Gin and Tonic', ja: 'ジントニック', zh: '金汤力' }, price: 12000, img: '🍸' },
  { id: 210, category: 'Drink', name: { ko: '모히토', en: 'Mojito', ja: 'モヒート', zh: '莫吉托' }, price: 12500, img: '🍹' },
  { id: 211, category: 'Drink', name: { ko: '콜드브루 아이스커피', en: 'Cold Brew Iced Coffee', ja: 'コールドブリュー', zh: '冷萃咖啡' }, price: 6500, img: '☕' },
  { id: 212, category: 'Drink', name: { ko: '유자 에이드', en: 'Yuja Ade', ja: 'ゆずエード', zh: '柚子气泡饮' }, price: 7000, img: '🍋' },
  { id: 213, category: 'Drink', name: { ko: '자몽 주스', en: 'Grapefruit Juice', ja: 'グレープフルーツジュース', zh: '西柚汁' }, price: 6500, img: '🧃' },
  { id: 214, category: 'Drink', name: { ko: '제로 콜라', en: 'Zero Cola', ja: 'ゼロコーラ', zh: '无糖可乐' }, price: 4000, img: '🥤' },
  { id: 215, category: 'Drink', name: { ko: '탄산수', en: 'Sparkling Water', ja: '炭酸水', zh: '苏打水' }, price: 5000, img: '💧' },
];
